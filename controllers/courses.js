...
// @access  Public 
// @details: get bootcamp related courses or all courses
...
// @access  Private 
// @details: get bootcamp if exists to add course to, check if auth user and add course or error msg
...
// @access  Private 
// @details: find course by id if exists, check if authorized user and update
...
// @access  Private 
// @details: find course by id, check if user authorized and delete or create error response
